...
<section class="table">
    ...
    <table id="horario">
        ...
        <tr><td class="ce"> Quarta-Feira </td>
            ...
            <td class="cd" colspan="2" id="alg"> Algoritmos e Linguagem de Programação <br/> <span id="prf">Emerson Ferreira de Araújo Lima</span> </td>
        </tr>
    ...
    <table>
        <caption style="background-color: rgba(0, 252, 32, .7);"><h2 align="center">Legendas <br> <span id="prf"> Separadas por São Firmino </span></h2></caption>
        ...
        <tr><td class="ce" id="dest"> Técnicas <br/> <span id="prf">Em Azul</span> </td>
            ...
            <td class="cd" id="alg"> Algoritmos e Linguagem de Programação <br/> <span id="prf">Emerson Ferreira de Araújo Lima</span> </td>
        </tr>
