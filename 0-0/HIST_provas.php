...
<section class="table">
    ...
    <table>
        <caption> <h3>Horario das Provas - 2º Bimestre <br/> (Atualizado Sábado, dia 10 de Novembro de 2015)</h3> </caption>
        <tr>  <td class="cd" id="jf" onclick="abrefecha('ja_feitas')"> Já feitas (13) | (Clique para abrir ou fechar)
        ...
        <tr>  <td class="cd" id="nm" onclick="abrefecha('nao_marcadas')"> Não marcadas (POR ENQUANTO) | (Clique para abrir ou fechar)
                <div class="ocult" id="nao_marcadas">
                    ...
                    <h4> Reposições não marcadas (06):</h4>
                    <p> - Educação Física </p>
                    <p> - Química </p>
                    <p> - Biologia </p>
                    <p> - Lógica </p>
        ...
        <tr>  <td class="cd" id="rec" onclick="abrefecha('recuperacao')"> Reposições (09) | (Clique para abrir ou fechar)
                <div class="ocult" id="recuperacao">
                    <br>
                    <table>
                        <tr>  <td class="cd" id="fil" style="text-align: left"> - Filosofia - 12/11 (Quinta-Feira):
                                <div>
                                    <p> - 1º Bimestre </p>
                        ...
                        <tr>  <td class="cd" id="port" style="text-align: left"> - Língua Portuguesa - 12/11 (Quinta-Feira):
                                <div>
                                    <p> - 1º Bimestre </p>
                                    ...
                                    <p> - 2º Bimestre </p>
                                        <p id="ident2"> - Trovadorismo: </p>
                                            ...
                                            <p id="ident3"> - cCantigas de maldizer </p>
                        ...
                        <tr>  <td class="cd" id="fis" style="text-align: left"> - Física - 13/11 (Sexta-Feira):
                                <div>
                                    <p> - 1º Bimestre </p>
                                    ...
                                    <p> - 2º Bimestre </p>
                                        ...
                                        <p id="ident2"> - M.R.V. e Gráficos </p>
                        ...
                        <tr>  <td class="cd" id="qui" style="text-align: left"> - Química - 17/11 (Quarta):
                                <div>
                                    <p> - 1º Bimestre </p>
                        ...
                        <tr>  <td class="cd" id="bio" style="text-align: left"> - Biologia - 17/11 (Quarta):
                                <div>
                                    <p> - 1º Bimestre </p>
                                        <p id="ident2"> - Todos os assuntos estudados </p>
                                    <p> - 2º Bimestre </p>
                        ...
                        <tr>  <td class="cd" id="alg" style="text-align: left"> - Algoritmos e Linguagem de Programação - 18/11 (Quarta):
                                <div>
                                    <p> - 1º Bimestre </p>
                                        <p id="ident2"> - Todos os assuntos estudados </p>
                                    <p> - 2º Bimestre </p>
        ...
        <tr>  <td class="cd" id="intv"> Futuras (02) <br/> <br/>
            <table>
                <tr>  <td class="cd" id="alg" style="text-align: left"> - Algoritmos e Linguagem de Programação (2AV) - 11/11 (Quarta-Feira):
                        <div>
                            <p id="ident2"> - Todos os assuntos até estruturas condicionais (If, Else, Elif)</p>
                        </div>
                    </td>
                </tr>
